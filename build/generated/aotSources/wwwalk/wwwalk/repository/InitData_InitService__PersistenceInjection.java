...
/**
 * Persistence injection for {@link InitData.InitService}.
 */
@Generated
public class InitData_InitService__PersistenceInjection {
  /**
   ...
   */
  public static InitData.InitService apply(RegisteredBean registeredBean,
      InitData.InitService instance) {
    Field field = ReflectionUtils.findField(InitData.InitService.class, "em");
