...
public class JpaBaseConfiguration__TestContext002_BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("wwwalk.wwwalk.entity.BaseEntity", "wwwalk.wwwalk.entity.Comment", "wwwalk.wwwalk.entity.Favorite", "wwwalk.wwwalk.entity.Like", "wwwalk.wwwalk.entity.Pin", "wwwalk.wwwalk.entity.Point", "wwwalk.wwwalk.entity.Route", "wwwalk.wwwalk.entity.User");
