 ...
 */
@Generated
public class WebSecurityConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getWebSecurityConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(WebSecurityConfiguration__TestContext002_Autowiring::apply);
  ...
  /**
   * Get the bean instance supplier for '(inner bean)#47f2c722'.
   */
