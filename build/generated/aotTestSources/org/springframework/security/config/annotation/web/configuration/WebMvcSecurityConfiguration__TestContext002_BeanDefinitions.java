 ...
 */
@Generated
public class WebMvcSecurityConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static class CompositeFilterChainProxy {
    ...
    public static BeanDefinition getSpringSecurityFilterChainBeanDefinition() {
      ...
      beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, ManagedList.of(HandlerMappingIntrospectorCacheFilterFactoryBean.getSpringSecurityFilterChainInnerBeanBeanDefinition(), WebSecurityConfiguration__TestContext002_BeanDefinitions.getSpringSecurityFilterChainInnerBeanBeanDefinition()));
