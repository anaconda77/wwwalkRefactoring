...
public class WebMvcSecurityConfiguration__TestContext001_BeanDefinitions {
  ...
  public static class CompositeFilterChainProxy {
    ...
    public static BeanDefinition getSpringSecurityFilterChainBeanDefinition() {
      ...
      beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, ManagedList.of(HandlerMappingIntrospectorCacheFilterFactoryBean.getSpringSecurityFilterChainInnerBeanBeanDefinition(), WebSecurityConfiguration__TestContext001_BeanDefinitions.getSpringSecurityFilterChainInnerBeanBeanDefinition()));
