 ...
 */
@Generated
public class P6SpyConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getPSpyConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(P6SpyConfiguration__TestContext001_Autowiring::apply);
