 ...
 */
@Generated
public class P6SpyConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getPSpyConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(P6SpyConfiguration__TestContext002_Autowiring::apply);
