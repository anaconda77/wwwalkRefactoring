...
import com.github.gavlyukovskiy.boot.jdbc.decorator.DataSourceDecoratorAutoConfiguration__TestContext001_BeanDefinitions;
import com.github.gavlyukovskiy.boot.jdbc.decorator.DataSourceDecoratorProperties__TestContext001_BeanDefinitions;
import com.github.gavlyukovskiy.boot.jdbc.decorator.p6spy.P6SpyConfiguration__TestContext001_BeanDefinitions;
...
import org.springframework.data.web.config.QuerydslWebConfiguration__TestContext001_BeanDefinitions;
...
import wwwalk.wwwalk.controller.RouteController__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.controller.UserController__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.exception.JwtAccessDeniedHandler__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.exception.JwtAuthentiactionEntryPoint__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.repository.CommentRepository__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.repository.InitDB__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.repository.LikeRepository__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.repository.PinRepository__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.repository.PointRepository__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.repository.RouteRepository__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.repository.UserRepository__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.security.MyUserDetailService__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.security.SecurityConfig__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.security.TokenProvider__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.service.RouteService__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.service.SessionManager__TestContext001_BeanDefinitions;
import wwwalk.wwwalk.service.UserService__TestContext001_BeanDefinitions;

/**
 * Register bean definitions for the bean factory.
 */
@Generated
public class WwwalkApplicationTests__TestContext001_BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("wwwalkApplication", WwwalkApplication__TestContext001_BeanDefinitions.getWwwalkApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("routeController", RouteController__TestContext001_BeanDefinitions.getRouteControllerBeanDefinition());
    beanFactory.registerBeanDefinition("userController", UserController__TestContext001_BeanDefinitions.getUserControllerBeanDefinition());
    beanFactory.registerBeanDefinition("jwtAccessDeniedHandler", JwtAccessDeniedHandler__TestContext001_BeanDefinitions.getJwtAccessDeniedHandlerBeanDefinition());
    beanFactory.registerBeanDefinition("jwtAuthentiactionEntryPoint", JwtAuthentiactionEntryPoint__TestContext001_BeanDefinitions.getJwtAuthentiactionEntryPointBeanDefinition());
    beanFactory.registerBeanDefinition("initDB", InitDB__TestContext001_BeanDefinitions.getInitDBBeanDefinition());
    beanFactory.registerBeanDefinition("routeRepository", RouteRepository__TestContext001_BeanDefinitions.getRouteRepositoryBeanDefinition());
    beanFactory.registerBeanDefinition("myUserDetailService", MyUserDetailService__TestContext001_BeanDefinitions.getMyUserDetailServiceBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("tokenProvider", TokenProvider__TestContext001_BeanDefinitions.getTokenProviderBeanDefinition());
    beanFactory.registerBeanDefinition("routeService", RouteService__TestContext001_BeanDefinitions.getRouteServiceBeanDefinition());
    beanFactory.registerBeanDefinition("sessionManager", SessionManager__TestContext001_BeanDefinitions.getSessionManagerBeanDefinition());
    beanFactory.registerBeanDefinition("userService", UserService__TestContext001_BeanDefinitions.getUserServiceBeanDefinition());
    beanFactory.registerBeanDefinition("wwwalk.wwwalk.repository.InitDB$InitService", InitDB__TestContext001_BeanDefinitions.InitService.getInitServiceBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("webSecurityCustomizer", SecurityConfig__TestContext001_BeanDefinitions.getWebSecurityCustomizerBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("preFilterAuthorizationAdvisor", PrePostMethodSecurityConfiguration__TestContext001_BeanDefinitions.getPreFilterAuthorizationAdvisorBeanDefinition());
    beanFactory.registerBeanDefinition("preAuthorizeAuthorizationAdvisor", PrePostMethodSecurityConfiguration__TestContext001_BeanDefinitions.getPreAuthorizeAuthorizationAdvisorBeanDefinition());
    beanFactory.registerBeanDefinition("postFilterAuthorizationAdvisor", PrePostMethodSecurityConfiguration__TestContext001_BeanDefinitions.getPostFilterAuthorizationAdvisorBeanDefinition());
    beanFactory.registerBeanDefinition("postAuthorizeAuthorizationAdvisor", PrePostMethodSecurityConfiguration__TestContext001_BeanDefinitions.getPostAuthorizeAuthorizationAdvisorBeanDefinition());
    beanFactory.registerBeanDefinition("jpaQueryFactory", WwwalkApplication__TestContext001_BeanDefinitions.getJpaQueryFactoryBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("com.github.gavlyukovskiy.boot.jdbc.decorator.p6spy.P6SpyConfiguration", P6SpyConfiguration__TestContext001_BeanDefinitions.getPSpyConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("jdbcEventListenerFactory", P6SpyConfiguration__TestContext001_BeanDefinitions.getJdbcEventListenerFactoryBeanDefinition());
    beanFactory.registerBeanDefinition("p6SpyDataSourceDecorator", P6SpyConfiguration__TestContext001_BeanDefinitions.getPSpyDataSourceDecoratorBeanDefinition());
    beanFactory.registerBeanDefinition("com.github.gavlyukovskiy.boot.jdbc.decorator.DataSourceDecoratorAutoConfiguration", DataSourceDecoratorAutoConfiguration__TestContext001_BeanDefinitions.getDataSourceDecoratorAutoConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("dataSourceDecoratorBeanPostProcessor", DataSourceDecoratorAutoConfiguration__TestContext001_BeanDefinitions.getDataSourceDecoratorBeanPostProcessorBeanDefinition());
    beanFactory.registerBeanDefinition("dataSourceNameResolver", DataSourceDecoratorAutoConfiguration__TestContext001_BeanDefinitions.getDataSourceNameResolverBeanDefinition());
    beanFactory.registerBeanDefinition("decorator.datasource-com.github.gavlyukovskiy.boot.jdbc.decorator.DataSourceDecoratorProperties", DataSourceDecoratorProperties__TestContext001_BeanDefinitions.getDataSourceDecoratorPropertiesBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.PinRepository.fragments#0", RepositoryComposition__TestContext001_BeanDefinitions.RepositoryFragments.getFragmentsBeanDefinition1());
    beanFactory.registerBeanDefinition("pinRepository", PinRepository__TestContext001_BeanDefinitions.getPinRepositoryBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.LikeRepository.fragments#0", RepositoryComposition__TestContext001_BeanDefinitions.RepositoryFragments.getFragmentsBeanDefinition2());
    beanFactory.registerBeanDefinition("likeRepository", LikeRepository__TestContext001_BeanDefinitions.getLikeRepositoryBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.CommentRepository.fragments#0", RepositoryComposition__TestContext001_BeanDefinitions.RepositoryFragments.getFragmentsBeanDefinition3());
    ...
    beanFactory.registerBeanDefinition("jpa.PointRepository.fragments#0", RepositoryComposition__TestContext001_BeanDefinitions.RepositoryFragments.getFragmentsBeanDefinition4());
    beanFactory.registerBeanDefinition("pointRepository", PointRepository__TestContext001_BeanDefinitions.getPointRepositoryBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.data.web.config.QuerydslWebConfiguration", QuerydslWebConfiguration__TestContext001_BeanDefinitions.getQuerydslWebConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("querydslPredicateArgumentResolver", QuerydslWebConfiguration__TestContext001_BeanDefinitions.getQuerydslPredicateArgumentResolverBeanDefinition());
    beanFactory.registerBeanDefinition("querydslBindingsFactory", QuerydslWebConfiguration__TestContext001_BeanDefinitions.getQuerydslBindingsFactoryBeanDefinition());
